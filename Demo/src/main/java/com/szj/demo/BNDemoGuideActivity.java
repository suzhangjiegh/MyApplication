...
/**
 *
 * 这个activity主要用于 导航诱导 可是百度给的Demo和解释不完全
 *
 */
public class BNDemoGuideActivity extends AppCompatActivity {

    private static final String TAG = BNDemoGuideActivity.class.getSimpleName();

    boolean useCommonInterface=true;
    BaiduNaviCommonModule mBaiduNaviCommonModule;
    BNRoutePlanNode mBNRoutePlanNode;
    BNRouteGuideManager.OnNavigationListener mOnNavigationListener;
    @Override
